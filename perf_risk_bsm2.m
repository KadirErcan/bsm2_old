...
% CHANGED: FIS object is now first argument
...
% CHANGED: Switched to modern mamfis framework
Risingfis = mamfis('Name', 'Rising');
%%%definition of the inputs
% CHANGED: addvar/addmf replaced with addInput/addMF
...
% CHANGED: addvar/addmf replaced with addOutput/addMF
...
% CHANGED: rule addition updated
Risingfis = addRule(Risingfis, rulelist);
writefis(Risingfis,'Risingfis');

% CHANGED: FIS object is now first argument
Rising1(i)=evalfis(Risingfis, [SNOOutReac5(i) ((SNOHighLimit(i)./Rdn2(i))+t_delay(i))]);
end
